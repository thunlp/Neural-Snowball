...
model = models.snowball.Snowball(sentence_encoder, base_class=train_val_data_loader.rel_tot, siamese_model=model2, hidden_size=230, neg_loader=train_train_data_loader)
