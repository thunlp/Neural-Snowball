...
val_data_loader = DataLoader('./data/val.json', vocab='./data/bert_vocab.txt', max_length=max_length, shuffle=False)
...
framework.eval_siamese(model, eval_iter=100, threshold=0.3, s_num_size=4, s_num_class=8)
print('')
framework.eval_siamese(model, eval_iter=100, threshold=0.5, s_num_size=4, s_num_class=8)
print('')
framework.eval_siamese(model, eval_iter=100, threshold=0.7, s_num_size=4, s_num_class=8)
print('')
framework.eval_siamese(model, eval_iter=100, threshold=0.9, s_num_size=4, s_num_class=8)
print('')
